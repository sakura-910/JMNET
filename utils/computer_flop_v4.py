...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, k_size=[3, 5, 5, 5]):
        ...
        self.dwconv3_1 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=3, stride=1, padding=1,
                                   groups=self.out_channels, bias=False)
        self.smooth_layer3_1 = Conv_BN_ReLU(self.out_channels, self.out_channels)

        self.dwconv2_1 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=3, stride=1, padding=1,
                                   groups=self.out_channels, bias=False)
        self.smooth_layer2_1 = Conv_BN_ReLU(self.out_channels, self.out_channels)

        self.dwconv1_1 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=3, stride=1, padding=1,
                                   groups=self.out_channels, bias=False)
        self.smooth_layer1_1 = Conv_BN_ReLU(self.out_channels, self.out_channels)

        self.dwconv2_2 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=3, stride=2, padding=1,
                                   groups=self.out_channels, bias=False)
        self.smooth_layer2_2 = Conv_BN_ReLU(self.out_channels, self.out_channels)

        self.dwconv3_2 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=3, stride=2, padding=1,
                                   groups=self.out_channels, bias=False)
        self.smooth_layer3_2 = Conv_BN_ReLU(self.out_channels, self.out_channels)

        self.dwconv4_2 = nn.Conv2d(self.out_channels, self.out_channels, kernel_size=3, stride=2, padding=1,
                                   groups=self.out_channels, bias=False)
    ...
    def forward(self, x):
        ...
        f11 = self.eca_layer1(f[0])
        f21 = self.eca_layer2(f[1])
        f31 = self.eca_layer3(f[2])
        f41 = self.eca_layer4(f[3])
