...
__all__ = ['eca_resnet18', 'eca_resnet50']
#__all__ = ['resnet18']
...
model_urls = {
    ...
    'eca_resnet50': 'http://sceneparsing.csail.mit.edu/model/pretrained_resnet/resnet50-imagenet.pth',
...
class ResNet(nn.Module):
    ...
    #def __init__(self, block, layers, num_classes=1000, k_size=[5, 5, 5, 7]):
...
def eca_resnet34(k_size=[3, 5, 5, 5], pretrained=False, **kwargs):
    """Constructs a Resnet-18 model.
    ...
    Args:
        ...
        num_classes:The classes of classification
    """
    model = ResNet(ECABasicBlock, [3, 4, 6, 3], k_size=k_size, **kwargs)
    #model.avgpool = nn.AdaptiveMaxPool2d(1)
    #model = ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
        model.load_state_dict(load_url(model_urls['eca_resnet34']), strict=False)
    return model

def eca_resnet50(k_size=[5, 5, 5, 7], pretrained=False, **kwargs):
    """Constructs a Resnet-18 model.
    ...
    Args:
        ...
        num_classes:The classes of classification
    """
    model = ResNet(ECABottleneck, [3, 4, 6, 3], k_size=k_size, **kwargs)
    #model.avgpool = nn.AdaptiveMaxPool2d(1)
    #model = ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
        model.load_state_dict(load_url(model_urls['eca_resnet50']), strict=False)
    return model
