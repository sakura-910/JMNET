...
def conv_final33(in_planes, out_planes, stride=1):
    "3x3 convolution with padding"
    return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, k_size=[3, 5, 5, 5]):
        ...
        self.conv4 = conv5x5(512, 256, stride=2)
        self.conv5 = conv_final33(256, 512)
        self.rnn = nn.Sequential(
            BidirectionalLSTM(512, 256, 256),
            BidirectionalLSTM(256, 256, 2))
...
if __name__ == '__main__':
    model = eca_resnet18(pretrained=False).cuda()
